    ...
    <div className="relative">
      ...
      <AnimatePresence mode="wait">
        {!draftState?.is_started ? (
          ...
          <motion.div key="paused" initial={{ height: 0 }} animate={{ height: 'auto' }} exit={{ height: 0 }} className="bg-red-600 text-white font-black text-center py-3 uppercase tracking-widest flex items-center justify-center gap-3 shadow-xl mb-6">
      ...
      <main className="max-w-[1600px] mx-auto p-4 md:p-6 grid grid-cols-12 gap-8">
        {/* LEFT COLUMN */}
                  ...
                  <section className="bg-slate-900 p-6 rounded-[2.5rem] border border-slate-800">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {!draftState.is_finished ? (
                        ...
                        <div className="bg-green-600/10 border border-green-500/30 rounded-3xl p-4 flex flex-col items-center justify-center text-green-500 font-black text-[10px] uppercase col-span-2 py-8 text-center">
                      ...
                      {!draftState.is_finished && (
                        <button 
                          ...
                          className="relative flex flex-col items-center justify-center gap-2 p-6 rounded-3xl font-black border border-slate-700 bg-slate-800 text-slate-300 hover:border-blue-500 uppercase text-[10px] transition-all disabled:opacity-20 disabled:cursor-not-allowed group/end text-center"
                        >
